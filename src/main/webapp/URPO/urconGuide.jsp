    ...
    <div class="container">
        ...
        <div class="">
        	<div class="guideCont">
				...
				등록없이 기본아이콘<img src="/resources/img/urpo/urcon/default.gif" style="width:50px;">만 쓰는 사람도 있고 독특한 자신만의 아이콘을 구매/제작 해서 쓰는 사람도 있는데요 만들고 싶어도 제작 방법과 사용 방법
				...
				지를 축소시켜 넣다보니 원본과 다르게 이미지가 뭉게지는 현상이 생기기도 합니다.
				아래의 예를 보면 위의 도트아이콘과 차이를 알 수 있습니다.
