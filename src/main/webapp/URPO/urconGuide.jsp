				...
				<div class="para">
					...
					<div class="paraContent">
						<div style="position:relative;">
							<div id="imgModal">
								<img  class ="urconGuideImg"src="/resources/img/urpo/urcon/default.gif" style="width:50px;">
							</div>
							&nbsp;URDO에서는 아이디와 함께 아이콘을 URDO 내에서 자신을 나타내는 하나의 아이템으로 사용하고 있습니다.<br> 
							&nbsp;기본아이콘(<button id="imgBtn">> 기본아이콘 보기 클릭< </button>)만 쓰는 사람도 있고 독특한 자신만의 아이콘을 구매/제작 해서 쓰는 사람도 있는데요 만들고 싶어도 제작 방법과 사용 방법
				...
				<div class="para">
					...
					<div class="paraContent">
						...
						<div class="paraIn">
							...
							니다. 마우스를 이용해서 선이나 면을 한번에 그어서 만드는게 아니라 정성스럽게(?) 점을 하나씩 연결해서 만든다고 보심 됩니다. 예를 들어 보면 아래와 같습니다.<br>
							<b>이미지아이콘</b>
						...
						<div class="paraIn">
							...
							<b>애니아이콘</b>
							&nbsp;&nbsp;만화영화가 초당 여러개의 컷으로 구성되어있다는 걸 잘 모르는 분들은 없을 겁니다. 움직이는 애니아이콘 도 하나가 아닌 여러개의 컷으로 구성되어 있는데 별도의 툴(Tool)을 이용해야 만들 수 있습니다. 컷이 늘어날수록 용량이 늘어 아이콘이 늦게 뜨거나 컷과 컷사이의 움직임이 부자연스러울 수 있으니 제작 에 유의합니다.
