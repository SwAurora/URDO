    ...
    <div class="tabContents on">
      ...
      <div class="tab1_page on">
        ...
        <span class="hov-anim-box">
          <img src="../img/pointShop/urcon6.bmp" alt="" class="static">
          <img src="../img/pointShop/urcon6.gif" alt="" class="animated">
          <div>
        ...
        <span class="hov-anim-box">
          <img src="../img/pointShop/urcon7.bmp" alt="" class="static">
          <img src="../img/pointShop/urcon7.gif" alt="" class="animated">
          <div>
            <p class="imgTitle">유알콘실시간인기</p>
        ...
        <span class="hov-anim-box">
          <img src="../img/pointShop/urcon10.bmp" alt="" class="static">
          <img src="../img/pointShop/urcon10.gif" alt="" class="animated">
          <div>
            <p class="imgTitle">유알콘실시간인기</p>
            <p class="imgDesc">2페이지입니다.</p>
          </div>
        ...
        <span class="hov-anim-box">
          <img src="../img/pointShop/urcon11.bmp" alt="" class="static">
          <img src="../img/pointShop/urcon11.gif" alt="" class="animated">
          <div>
            <p class="imgTitle">유알콘실시간인기</p>
            <p class="imgDesc">2페이지입니다.</p>
          </div>
        ...
        <span class="hov-anim-box">
          <img src="../img/pointShop/urcon12.bmp" alt="" class="static">
          <img src="../img/pointShop/urcon12.gif" alt="" class="animated">
          <div>
            <p class="imgTitle">유알콘실시간인기</p>
            <p class="imgDesc">2페이지입니다.</p>
          </div>
      ...
      <div class="tab1_page">
        <span class="hov-anim-box">
          <img src="../img/pointShop/pointshop.png" alt="" class="static">
          <img src="../img/pointShop/pointshop.gif" alt="" class="animated">
          <div>
            <p class="imgTitle">유알콘실시간인기</p>
            <p class="imgDesc">2페이지입니다.</p>
          </div>
