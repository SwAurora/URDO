    ...
    <div class="container">
        ...
        <div id="search">
            ...
            <form id="searchFrm" action="/Board/search.do" onsubmit="return false">
	        	<input type="hidden" name="subject" value="regionRestaurant">
        ...
        <div class="board_list_wrap">
            <form action="/Board/regionRestaurant.do" method="get">
            ...
            <table class="board_list" id="t1">
                ...
                <tr id="tableContent">
                    ...
                    <td><a href="/Board/read.do?board=regionRestaurant&no=<%=boardDTO.getNo()%>"><%=boardDTO.getTitle()%>
                    </a>
                    </td>
        ...
        <div class="boardfoot">
            <div class="page_wrap">
                ...
                <div class="page_nation">
                    ...
                    %>
                    <a class="page_num on"
                       href="/Board/regionRestaurant.do?limit=<%=limit%>&page=<%=pageStart%>"><%=pageStart%>
                    </a>
                    <%
                    }
                    else
            ...
            <script>
                function loginchk()
                {
                    <%
                            ...
                            {
                    %>
                    location.href = "/Board/post.do?subject=regionRestaurant";
                    <%
                            }
                            else
                            {
    ...
    <script>
        ...
        function block(num)
        {
            ...
            if(num === 1)
            {
                ...
                location.href= "/Board/regionRestaurant.do?limit=" + <%=limit%> + "&page=" + page;
            }
            else
            {
