...
import java.sql.*;
import java.util.Properties;    //Map과 동일한 형태의 컬렉션 + 설정내용 바로 적용
import java.util.Vector;        //DBConn객체 저장용 컬렉션(스레드에 안전함)
...
//    private String _driver = "com.mysql.cj.jdbc.Driver", _url = "jdbc:mysql://127.0.0.1:3306/urdo?useUnicode=true&characterEncoding=UTF-8", _user = "root", _password = "1234";
    private String _driver = "com.mysql.cj.jdbc.Driver", _url = "jdbc:mysql://127.0.0.1:3306/urdo?useUnicode=true&characterEncoding=UTF-8", _user = "manager", _password = "1234";
