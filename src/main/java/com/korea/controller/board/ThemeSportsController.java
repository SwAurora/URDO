...
public class ThemeSportsController implements SubController
{
    BoardService service = BoardService.getInstance();
    String subject = "themeSports"; // DB 테이블명
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp)
    {
        try
        {
            ...
            req.getRequestDispatcher("/board/themeSports.jsp").forward(req, resp);
        }
        catch(Exception e)
        {
            e.printStackTrace();
