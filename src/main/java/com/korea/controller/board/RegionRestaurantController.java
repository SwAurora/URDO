...
public class RegionRestaurantController implements SubController
{
    BoardService service = BoardService.getInstance();
    String subject = "regionRestaurant"; // DB 테이블명
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp)
    {
        try
        {
            ...
            req.getRequestDispatcher("/board/regionRestaurant.jsp").forward(req, resp);
        }
        catch(Exception e)
        {
            e.printStackTrace();
