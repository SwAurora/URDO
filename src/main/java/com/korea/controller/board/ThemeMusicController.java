...
public class ThemeMusicController implements SubController
{
    BoardService service = BoardService.getInstance();
    String subject = "themeMusic"; // DB 테이블명
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp)
    {
        try
        {
            ...
            req.getRequestDispatcher("/board/themeMusic.jsp").forward(req, resp);
        }
        catch(Exception e)
        {
            e.printStackTrace();
