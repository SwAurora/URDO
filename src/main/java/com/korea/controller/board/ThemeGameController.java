...
public class ThemeGameController implements SubController
{
    BoardService service = BoardService.getInstance();
    String subject = "themeGame"; // DB 테이블명
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp)
    {
        try
        {
            ...
            req.getRequestDispatcher("/board/themeGame.jsp").forward(req, resp);
        }
        catch(Exception e)
        {
            e.printStackTrace();
